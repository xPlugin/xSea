    ...
    void execute(CommandSender sender, CommandArguments args) {
        if(sender instanceof Player player) {
            ...
            switch (toggle) {
                ...
                case "info" -> player.sendMessage(TextWrapper.text("Debug режим - позволяет отслеживать перезагрузки плагина <u>[xSea]</u>, и отслеживать изменения если у вас есть права оператора."));
                default -> {
